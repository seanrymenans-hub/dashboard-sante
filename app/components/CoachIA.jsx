    ...
    <div className="bg-white rounded-xl border border-gray-100 p-6 mb-6">
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <div className="text-xs text-gray-400">Bilan de la semaine + conseils personnalisés</div>
        </div>
      ...
      {!data && !loading && (
        <div className="text-center py-6">
          <div className="text-gray-400 text-sm mb-4">
            Ton coach analyse toutes tes données pour te donner un bilan personnalisé et des conseils pour accélérer ta progression
          </div>
      ...
      {data && (
        <div>
          ...
          {data.positifs?.length > 0 && (
            <div className="mb-4">
              <div className="text-xs font-medium text-green-700 mb-2">✓ Ce qui va bien</div>
          ...
          {data.conseils?.length > 0 && (
            <div>
              <div className="text-xs font-medium text-purple-700 mb-2">💡 Pour aller plus vite</div>
